...
export default function ChatPage() {
	return (
		<div className="mx-auto flex w-full max-w-4xl flex-col gap-8 px-4 py-8 sm:px-6 lg:px-8 lg:py-10">
			<div>
				<p className="text-xs font-medium tracking-wide text-cyan-700">AI mentor chat</p>
				<h1 className="mt-2 text-3xl font-semibold text-slate-100 sm:text-4xl">Talk to your career mentor</h1>
