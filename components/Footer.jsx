...
export default function Footer() {
	return (
		<footer className="border-t border-slate-700/20 bg-white/70 backdrop-blur-md">
			<div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
				<div className="grid gap-8 md:grid-cols-3">
					<div>
						<p className="font-display text-lg font-bold text-slate-100 tracking-tight">CareerCompass AI</p>
					...
					<div>
						<p className="text-sm font-semibold tracking-wide text-slate-200">Platform</p>
					...
					<div>
						<p className="text-sm font-semibold tracking-wide text-slate-200">Built for</p>
						<p className="mt-4 text-sm leading-relaxed text-slate-400">
							Microsoft Agents League Hackathon — empowering students with AI-driven career guidance.
						</p>
					</div>
				</div>
				<div className="mt-10 border-t border-slate-700/20 pt-6 text-center text-xs text-slate-500">
