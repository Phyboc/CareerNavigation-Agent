		...
		<section className="py-6">
			...
			<Reveal className="mt-10 grid gap-6 md:grid-cols-3">
				{testimonials.map((item, index) => (
					<Reveal key={item.name} delay={index * 0.1} className="contents">
					<blockquote
					...
					>
						...
						<footer className="mt-6 border-t border-slate-700/15 pt-4 flex items-center gap-3">
							<div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-cyan-500 to-cyan-700 font-display text-sm font-bold text-white dark:from-cyan-600 dark:to-cyan-900">
								{item.initials}
							</div>
							<div>
