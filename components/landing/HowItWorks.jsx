		...
		<section id="how-it-works" className="scroll-mt-24">
			...
			<div className="mt-10 grid gap-6 md:grid-cols-2 lg:grid-cols-4">
				{steps.map(item => (
					...
					>
						<div className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-cyan-500 to-cyan-700 font-display text-sm font-black text-white shadow-[0_0_15px_rgba(15,118,110,0.2)]">
							{item.step}
						</div>
