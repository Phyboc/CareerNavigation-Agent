...
const variants = {
	primary:
		"bg-gradient-to-r from-cyan-500 to-cyan-700 text-white shadow-[0_4px_20px_rgba(15,118,110,0.25)] hover:brightness-110 active:scale-[0.98] active:translate-y-[0.5px] dark:from-cyan-600 dark:to-cyan-900",
	secondary:
