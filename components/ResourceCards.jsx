...
export default function ResourceCards({ resources }) {
  ...
  return (
    <section className="rounded-[32px] border border-white/10 bg-white/5 p-6 shadow-[0_20px_60px_rgba(8,145,178,0.07)] backdrop-blur">
      <p className="text-sm font-medium tracking-wide text-cyan-200">Recommended resources</p>
