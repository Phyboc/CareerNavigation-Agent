/**
 * Deterministic, network-free mentor insight builder.
 * Safe to import from client components – never touches the AI provider.
 * Used as a fallback when the AI mentor endpoint is unavailable.
 * @param {object} [analysis] – The full analysis object.
 * @returns {{ paragraphs: string[], highlight: object }}
 */
export function buildStaticMentorInsights(analysis = {}) {
